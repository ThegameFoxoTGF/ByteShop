...
const updateCoupon = asyncHandler(async (req, res) => {
    ...
    if (coupon) {
        ...
        coupon.discount_value = req.body.discount_value !== undefined ? req.body.discount_value : coupon.discount_value;
        coupon.min_order_value = req.body.min_order_value !== undefined ? req.body.min_order_value : coupon.min_order_value;
        coupon.max_discount_amount = req.body.max_discount_amount !== undefined ? req.body.max_discount_amount : coupon.max_discount_amount;
        coupon.usage_limit = req.body.usage_limit !== undefined ? req.body.usage_limit : coupon.usage_limit;
        coupon.usagePerUser = req.body.usagePerUser !== undefined ? req.body.usagePerUser : coupon.usagePerUser;
